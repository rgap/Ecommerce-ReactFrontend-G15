...
export default function Footer() {
  ...
  return (
    ...
    <div
      className="mr-6 ml-6 md:mr-20 md:ml-20 color-text-white flex flex-col justify-between lg:flex-row"
    >
      ...
      <div
        className="footer-right color-text-white max-md:text-left grid grid-cols-2 md:gap-x-20 gap-x-[25vw]"
      >
        <div className="">
          ...
          <ul className="md:text-lg md:font-normal">
            ...
            <li className="leading-10 cursor-pointer">Politica de Privacidad</li>
          </ul>
        </div>
        <div>
    ...
    <div
      className="ml-6 md:ml-20 max-sm:text-xs md:text-sm gap-1.5 mt-8 color-text-white flex justify-start items-center"
    >
      <img
        className="w-[16px]"
