    ...
    <section className="flex justify-center">
      <div className="bg-e7dfd5 text-center p-16 max-w-[1000px]">
        ...
        <p className="text-lg mb-0 text-black">
          ¡Recientemente hemos incorporado esta exclusiva línea de polos!
        </p>
        <p className="text-lg mb-0 text-black">
          Experimenta la calidad, comodidad y elegancia que solo la lana merino
          puede ofrecer.
        </p>
      </div>
    </section>
      ...
      <section className="max-w-[1000px]  flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-12 px-[50px] py-[30px] bg-gray-100 shadow-lg">
          <div>
            ...
            <p className="text-lg">
              Los polos de Merino mantienen tu temperatura corporal,
              permitiéndote sentirte fresco en climas cálidos y cálido en climas
              fríos.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-12  px-[50px] py-[30px] bg-gray-100 shadow-lg">
          ...
          <div>
            ...
            <p className="text-lg">
              La lana de Merino posee propiedades anti-microbianas naturales, lo
              que hace que los polos sean resistentes al olor incluso después de
              usos prolongados.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center  px-[50px] py-[30px] bg-gray-100 shadow-lg">
          <div>
            ...
            <p className="text-lg">
              Los polos de Merino son conocidas por sus propiedades de absorción
              de humedad. Estas pueden absorber y liberar la humedad al
              ambiente, manteniéndote seco y cómodo en todas las condiciones.
            </p>
          </div>
          <div className="m-auto">
            <img
        ...
        <div className="p-8 bg-[--color-cart-bg-gray] text-center  shadow-lg mx-auto">
          <div className="max-w-md	 flex flex-col m-auto">
            ...
            <p className="mb-6">
              ...
              lana merino al completar este formulario!
            </p>
            <form
              autoComplete="off"
            ...
            {submitted && ( // Add this conditional rendering block
              <p className="mt-4 text-orange-900">
                ¡Formulario enviado con éxito! Pronto recibirás tu descuento.
              </p>
            )}
          </div>
        </div>
