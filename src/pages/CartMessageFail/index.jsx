    ...
    <>
      <div className=" text-center md:h-screen flex flex-col justify-center items-center gap-10 bg-white">
        <img
          ...
          alt=""
        />
        <p className="text-[#C30000] text-[40px] font-bold capitalize leading-10 break-words">
          ERROR
        </p>
        <p className="text-xl">
          {" "}
          Desafortunadamente su orden no pudo ser procesada.
        </p>
        <p className="text-xl text-center break-words">
          Asegúrese de que la dirección de facturación es la misma en la que
          está registrada su tarjeta de débito/crédito
        </p>
        <p className="text-xl text-center break-words">
          Si lo prefiere, pruebe con otro método de pago.
        </p>
