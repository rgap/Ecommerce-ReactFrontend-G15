export default function CartMessage(){
    ...
    return(
      ...
      />
      <p
        className="text-[#00966D] text-[40px] font-bold capitalize leading-10 break-words"
      >
        Pago exitoso
      </p>
      <p className="text-xl"> <span className="font-semibold"> GRACIAS </span> , su orden sera <span className="font-semibold">GENERADA</span>  en los proximos minutos.</p>
      <p className="text-xl">El recibo de su transaccion ha sido enviado a su <span className="font-semibold"> email </span> .</p>

      <p className="text-lg text-[#404040]">Contactenos en caso de alguna duda con respecto a su pedido.</p>
