  ...
  return (
    ...
    <div className="lg:flex">
      ...
      <section className="cart-info-left lg:w-[60%] flex flex-col">
        ...
        <div className="breadcrumb max-sm:hidden flex gap-3   text-sm mx-20">
      ...
      <section className="max-lg:hidden cart-info-right lg:w-[40%] h-screen bg-[--color-bg] flex flex-col justify-start items-center">
        ...
        <div className="mt-5 flex flex-col w-full mr-20">
          <div className="">
            <p className="mb-2 text-lg text-end">
              Subtotal: <span> S/. {total} </span>
            </p>
            <p className="mb-2 text-lg text-end ">
              Envio: <span> S/ {envio} </span>
            </p>
            <p className="mb-2 text-lg text-end "> Total: S/ {totalenvio} </p>
          </div>
        </div>
      </section>
    </div>
